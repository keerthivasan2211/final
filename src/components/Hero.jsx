...
const Hero = () => {
  return (
    <div className='border-b border-neutral-100 pb-10 lg:mb-35'>
        <div className='flex flex-wrap'>
            ...
            <div className='flex flex-col items-center lg:items-start'>
                ...
                initial="hidden"
                animate="visible"className='bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-4xl tracking-tight text-transparent '>Web Developer</motion.span>
   ...
   <a href={resume} class="text-white-100 font-bold hover:text-gray-800 hover:underline">
  Download CV
</a>
</motion.p>
            </div>
